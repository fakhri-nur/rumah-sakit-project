...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="page-title"><i class="bi bi-person-badge me-2"></i>Data Dokter</h4>
        <div class="d-flex gap-2">
            <a href="{{ route('admin.dokter.trash') }}" class="btn btn-outline-success btn-modern">
                <i class="bi bi-trash3 me-1"></i> Data Sampah
            </a>
            <a href="{{ route('admin.dokter.export') }}" class="btn btn-outline-primary btn-modern">
                <i class="bi bi-file-earmark-excel me-1"></i> Export (.xlsx)
            </a>
            <a href="{{ route('admin.dokter.create') }}" class="btn btn-success btn-modern">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center gap-2">
                                        ...
                                        <form action="{{ route('admin.dokter.delete', $user->id) }}" method="POST" onsubmit="return confirm('Yakin mau hapus data ini?')">
                                            @csrf
                                            @method('DELETE')
